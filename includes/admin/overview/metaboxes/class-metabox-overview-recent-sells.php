 ...
 */
class Recent_Sells extends Meta_Box implements Meta_Box\Base {
	...
	public function init() {
		$this->action        = 'affwp_overview_meta_boxes';
		$this->meta_box_name = __( 'Recent Sells', 'affiliate-wp' );
		$this->meta_box_id   = 'overview-recent-sells';
	...
	public function content() {
		...
		<table class="affwp_table">
			...
			<?php else : ?>
				<tr>
					<td colspan="3"><?php _e( 'No fresh sells recorded yet', 'affiliate-wp' ); ?></td>
				</tr>
			<?php endif; ?>
			</tbody>
