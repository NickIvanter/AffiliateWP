 ...
 */
class Most_Valuable_Sellers extends Meta_Box implements Meta_Box\Base {
	...
	public function init() {
		$this->action        = 'affwp_overview_meta_boxes';
		$this->meta_box_id   = 'overview-most-valuable-sellers';
		$this->context       = 'secondary';
		$this->meta_box_name = __( 'Most Valuable Sellers', 'affiliate-wp' );
	}
			...
			<?php if( $affiliates ) : ?>
				<?php foreach( $affiliates as $affiliate  ) : ?>
					<tr>
						...
						<td><?php echo affwp_currency_filter( affwp_format_amount( $affiliate->sell_earnings ) ); ?></td>
				        <td><?php echo affwp_format_amount( absint( $affiliate->sell_referrals ), false ); ?></td>
						<td><?php echo affwp_format_amount( absint( $affiliate->sell_visits ), false ); ?></td>
					</tr>
				<?php endforeach; ?>
			<?php else : ?>
				<tr>
