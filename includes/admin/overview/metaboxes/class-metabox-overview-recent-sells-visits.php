 ...
 */
class Recent_Sells_Visits extends Meta_Box implements Meta_Box\Base {
	...
	public function init() {
		$this->action        = 'affwp_overview_meta_boxes';
		$this->meta_box_name = __( 'Recent Sells Visits', 'affiliate-wp' );
		$this->meta_box_id   = 'overview-recent-sells-visits';
