	...
	if( isset( $_GET['action'] ) && 'add_sell' == $_GET['action'] ) {
		...
		<div class="wrap">
			...
			<div id="affwp-referrals-export-wrap">
				...
				<form id="affwp-referrals-export-form" style="display:none;" class="affwp-batch-form" data-batch_id="generate-payouts-sells" data-nonce="<?php echo esc_attr( wp_create_nonce( 'generate-payouts-sells_step_nonce' ) ); ?>" data-ays="<?php esc_attr_e( 'Are you sure you want to generate the payout file? All included referrals will be marked as Paid.', 'affiliate-wp' ); ?>">
