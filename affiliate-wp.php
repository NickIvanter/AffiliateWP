...
final class Affiliate_WP {
	 ...
	 * @var    string
	 */
	private $version = '2.0.6.5-custom';
	...
	private function includes() {
		...
		if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
			...
			require_once AFFILIATEWP_PLUGIN_DIR . 'includes/admin/sellers/affiliates.php';
			...
			require_once AFFILIATEWP_PLUGIN_DIR . 'includes/admin/sells/actions.php';
			require_once AFFILIATEWP_PLUGIN_DIR . 'includes/admin/sells/referrals.php';
			...
			require_once AFFILIATEWP_PLUGIN_DIR . 'includes/admin/sell_visits/visits.php';
